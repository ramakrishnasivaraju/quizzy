class AdminDashboard {
    ...
    async fetchDashboardStats() {
        try {
            const response = await fetch('http://localhost:5000/api/v1/quizzes/stats', {
    ...
    async fetchStudents() {
        try {
            const response = await fetch('http://localhost:5000/api/v1/users/students', {
                headers: { 'Authorization': `Bearer ${this.token}` }
            });
            const data = await response.json();
    ...
    async deleteQuiz(id) {
        ...
        try {
            const response = await fetch(`http://localhost:5000/api/v1/quizzes/${id}`, {
                method: 'DELETE',
                headers: { 'Authorization': `Bearer ${this.token}` }
            });
    ...
    async deleteStudent(id) {
        ...
        try {
            const response = await fetch(`http://localhost:5000/api/v1/users/students/${id}`, {
                method: 'DELETE',
                headers: { 'Authorization': `Bearer ${this.token}` }
            });
    ...
    async populateSubjectDropdown() {
        try {
            const response = await fetch('http://localhost:5000/api/v1/subjects', { headers: { 'Authorization': `Bearer ${this.token}` } });
            const data = await response.json();
            if (response.ok) {
    ...
    async populateQuizDropdown() {
        try {
            const response = await fetch('http://localhost:5000/api/v1/quizzes', { headers: { 'Authorization': `Bearer ${this.token}` } });
            const data = await response.json();
            if (response.ok) {
